...
template_notes = {
    "Broken up over Major blues scale with eights 2 bar:C7":
        ["c'", "d'", "ees'", "e'", "d'", "ees'", "e'", "g'", "ees'", "e'", "g'", "a'", "e'", "g'", "a'", "c''",
         "c''", "d''", "ees''", "e''", "d''", "ees''", "e''", "g''", "ees''", "e''", "g''", "a''", "e''", "g''", "a''",
         "c'''"],
    "Broken up over minor blues scale with eights 2 bar:Cm7":
        ["c'", "ees'", "f'", "fis'", "ees'", "f'", "fis'", "g'", "f'", "fis'", "g'", "bes'", "fis'", "g'", "bes'",
         "c''",
         "c''", "ees''", "f''", "fis''", "ees''", "f''", "fis''", "g''", "f''", "fis''", "g''", "bes''", "fis''", "g''", "bes''",
         "c'''"]
